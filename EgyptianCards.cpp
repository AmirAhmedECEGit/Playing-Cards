...
//3.2.2 doubly
//used to create the queue data structure
class DoublyNode{
public:
	int Data;
	DoublyNode* Next;
...
public:
	...
	void Play()
	{
        ...
        Clocks_Elapsed_In_Processor_Speed+=(Clocks()-clockstart);
			...
			cout<<"Total time of overall game computations in Seconds: "<<total_time<<"\n";
            cout<<"\Total Clocks of overall game computations in Processor: "<<total_clocks<<"\n";
		 }
};
...
/*5.5- Class Money AI vs AI
	2.1- Card_Deck
	2.2- CardStack
	2.3- CardQueue
	2.4- AI vs AI*/
class Money_AI_vs_AI
{private:
Deck Cards;
CardQueue AI1;
CardQueue AI2;
...
public:
	...
	void Text()
	{
		cout<<"-------------------------------------------------\n\t\t     MONEY!\n";
		cout<<"-------------------------------------------------\n";
		cout<<"AI1 Cards:	"<<AI1.Cards_Count;
		cout<<"\nFloor Cards:	"<<Field.Cards_Count;
		cout<<"\nAI2 Cards:	"<<AI2.Cards_Count;
		if(AI1.Cards_Count>0 && AI2.Cards_Count>0)
		{
		cout<<"\nCurrent AI1 Top Card:		";
		AI1.TopCard();
		cout<<"\nCurrent Floor Top Card:		";
		Field.TopCard();
		cout<<"\nCurrent AI2 Top Card:	";
		AI2.TopCard();
		}
		else
		{
	...
	void opening_game()
	{
		for(int i=0;i<N*6.5;i++) //N is the hand parameter and number of cards intially equals 4
			{
				AI1.AddCard(Cards.DrawCard());
				AI2.AddCard(Cards.DrawCard());
			}
	}
	void win(int i)
	{
	...
	bool WinOrBooze(int i)
	{
	    if(i == 1)  //AI1 play
	    {
	        if(AI1.peek() == Field.peek())
            {
				cout<<"AI1 top most card is same as floor, AI1 eats floor cards\n";
                Field.push(AI1.RemoveCard());
                return 1;
            }
            else
            {
        ...
        {
            if(AI2.peek() == Field.peek())
            {
                cout<<"AI2 top most card is same as floor, AI2 eats floor cards\n";
                Field.push(AI2.RemoveCard());
                return 1;
            }
            else
            {
...
void Play()
	{
        ...
        Clocks_Elapsed_In_Processor_Speed+=(Clocks()-clockstart);
			...
			while (AI1.Cards_Count>0 && AI2.Cards_Count>0)
            {
                Text();
				if(AI1.IsEmpty()) break;
                cout<<"AI1 to Play Card to Floor	: \n";
                timestart = Now();
                clockstart = Clocks();
                if(WinOrBooze(1))
                    win(1);
			...
			if(AI1.Cards_Count==0) cout<<"AI1 Ran Out Of Cards, AI2 Wins\n";
			else if(AI2.Cards_Count==0)cout<<"AI2 Ran Out OF Cards, AI1 Wins\n";
			cout<<"Total time of overall game computations in Seconds: "<<total_time<<"\n";
            cout<<"\Total Clocks of overall game computations in Processor: "<<total_clocks<<"\n";
		 }
};
...
Class BlackJack
	1.1- Card_Deck
	1.2- Playing_Hand
	1.3- black jack AI1 and black jack AI2
*/
	class BlackJack_AI_vs_AI
	{
	private:
		Deck Cards;
		Playing_Hand AI1;
	...
	void Text()
	{
		cout<<"-------------------------------------------------\n\t\t BLACKJACK 21\n";
		cout<<"-------------------------------------------------\n";
		cout<<"AI1 Coins:	"<<Coins_AI1;
		cout<<"\tAI2 Coins:	"<<Coins_AI2;
		cout<<"\n-------------------------------------------------\n";
	}
	void Draw1()
	{			
		while ((AI1.Sum)<16)
			{
				AI1.DrawCard(Cards.NumberDrawCard());
			}
	}
	void Draw2()
	{			
		while ((AI2.Sum)<16)
			{
				AI2.DrawCard(Cards.NumberDrawCard());
			}
	}
	void Play()
	{
		...
		while(Coins_AI1>0 && Coins_AI2>0)
		{
			...
			cout<<"Round: "<<i<<"\n";
				Draw1();
				cout<<"AI1's turn to play, AI Draws "<<AI1.Count<<" Cards";
				cout<<"\nAI1 Cards:	";AI1.DisplayHand();
				cout<<"AI1 Sum:\t"<<AI1.Sum;
				cout<<"\n-------------------------------------------------\n";
				Draw2();
				cout<<"AI2's turn to play, AI Draws "<<AI2.Count<<" Cards";
				cout<<"\nAI2 Cards:	";AI2.DisplayHand();
				cout<<"AI2 Sum:\t"<<AI2.Sum;
				cout<<"\n-------------------------------------------------\n";

			if(AI1.Sum>21)
				{
					cout<<"AI1 Busted (Cards Sum is More Than 21), AI2 take 10 Coins!\n";
					Coins_AI1-=10;
					Coins_AI2+=10;
				}
				else if(AI2.Sum>21)
				{
					cout<<"AI2 Busted (Cards Sum is More Than 21), AI1 take 10 Coins!\n";
					Coins_AI1+=10;
					Coins_AI2-=10;
				}
				else if(AI2.Sum>AI1.Sum)
				{
					cout<<"AI2 Cards Near 21, AI2 takes 10 Coins!\n";
					Coins_AI1-=10;
					Coins_AI2+=10;
				}
				else if(AI1.Sum>AI2.Sum)
				{
					cout<<"AI1 Cards Near 21, AI1 take 10 Coins!\n";
					Coins_AI1+=10;
					Coins_AI2-=10;
				}
				else //(AI1.Sum==AI2.Sum)
				{
					cout<<"Tie!, Coins remain the same!\n";
				}
				AI1.ResetHand();
				AI2.ResetHand();
				Cards.Reset_Deck();
				total_time+= (Now() - time_1);
				total_clocks+= (Clocks() - clocks_1);
				i++;
		}
		Text();
		if(Coins_AI1 == 0) cout<<"\nAI1 loses AI2 wins \n";
		else if(Coins_AI2 == 0) cout<<"\nAI2 loses AI1 Wins \n";
		cout<<"\nTotal time taken "<<total_time<<" seconds\n";
		cout<<"\nTotal clocks taken "<<total_clocks<<" clocks\n";
	}
	};
...
int main()
{
	...
	while(true)
	{
		...
		cout<<"1- Egyptian Basra	(Komey): normal mode Player vs AI\n";
		cout<<"2- Feloos		(Money Game): normal mode Player vs AI\n";
		cout<<"3- The 21		(BlackJack): normal mode Player vs AI\n";
		cout<<"4- Egyptian Basra	(Komey): Time Complexity mode AI vs AI\n";
		cout<<"5- Feloos		(Money Game): Time Complexity mode AI vs AI\n";
		cout<<"6- The 21		(BlackJack): Time Complexity mode AI vs AI\n";
		cout<<"Option: ";
		Option = PA_Opt_in(6);
		if (Option==1)
		{
		...
		cout<<"cards in hand chosen... N = "<<N<<"\n";
		cout<<"Total Cards in deck: "<<N*13<<" cards \n";
			Basra_AI_vs_AI Game4 = Basra_AI_vs_AI();
			Game4.Play();
			Game4.Reset();
		}
		else if (Option==5)
		{
			Money_AI_vs_AI Game5 = Money_AI_vs_AI();
			Game5.Play();
			Game5.Reset();
		}
		else //(Option == 6)
		{
			BlackJack_AI_vs_AI Game6 = BlackJack_AI_vs_AI();
			Game6.Play();
			Game6.Reset();
		}
		cout<<"Game Over!\n1. Play Again\n2. Exit\nOption: ";
